...
<div class="vertical-tabs-panes"> 
	...
	<div id="tabs-5">
		<fieldset class="">
			...
			<div><?php echo $this->Layout->getAuthor('Content');?></div>
			<label><?php echo __('Modified');?></label>
			<div><?php echo $this->request->data('Content.modified');?></div>
			<label><?php echo __('Modified By');?></label>
			<div>
				<?php
					$uid = $this->request->data('Content.modified_by'); 
					echo $this->Layout->getAuthor('Content', $uid, 'modified');?>
