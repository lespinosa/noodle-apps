...
<section id="header">
	<header>
		<div class="container_12">
			<div class="logo grid_4"><?php echo $this->Html->image('site/logo.png', array('alt' => 'Noodle Apps'));?></div>
		<div class="grid_8"><h1><?php echo $this->Html->link($cakeDescription, 'http://cakephp.org'); ?></h1></div>
		</div>
		<nav class="top-menu">
			<?php echo $this->Layout->getWidget('position-1'); ?>
		</nav>
