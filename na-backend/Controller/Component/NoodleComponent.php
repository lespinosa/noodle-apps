...
class NoodleComponent extends Component
{
	...
	//instar engadget
	function install($ymlSetup, $type = ''){
		switch ($type) {
			case 'plugin':
			...
			case 'widget':
				...
				$app->Engadget->set(array(
					'name' => $ymlSetup['info']['name'],
					'title' => $ymlSetup['info']['title'],
					'location' => $ymlSetup['info']['location'],
					'status' => $ymlSetup['info']['status'],
					'type' => $ymlSetup['info']['type'],
					'version' => $ymlSetup['info']['version'],
					'date' => $ymlSetup['info']['date'],
					'author' => $ymlSetup['info']['author'],
					'description' => $ymlSetup['info']['desc'],
				));
				$app->Engadget->save();
